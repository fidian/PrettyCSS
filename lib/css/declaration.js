...
var propertyMapping = {
	...
	'-khtml-border-radius': valueWrapper.deprecated(valueBucket['border-radius'], 'border-radius'),
	...
	'progress-appearance': valueWrapper.wrongProperty(valueBucket['ms-progress-appearance'], 'ms-progress-appearance'),
