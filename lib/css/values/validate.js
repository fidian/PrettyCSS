...
exports.maximumCss = function (maxVersion) {
	return function (token) {
		if (! this.parser.options.cssLevel || this.parser.options.cssLevel > maxVersion) {
...
exports.minimumCss = function (minVersion) {
	return function (token) {
		if (! this.parser.options.cssLevel || this.parser.options.cssLevel < minVersion) {
...
exports.notForwardCompatible = function (badVersion) {
	return function (token) {
		if (! this.parser.options.cssLevel || this.parser.options.cssLevel <= badVersion) {
